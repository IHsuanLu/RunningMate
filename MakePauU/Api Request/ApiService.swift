...
class ApiService: NSObject{
    ...
    func postResgister(registerInfo: RegisterInfo, completion: @escaping (Bool, String) -> ()){
        ...
        let checkSessionURL = URL(string: "http://172.20.10.11/register_member/")
    ...
    func postLogin(loginInfo: LoginInfo, completion: @escaping (String) -> ()){
        ...
        let checkSessionURL = URL(string: "http://172.20.10.11/login_member/")
    ...
    func postUserPosition(userLocation: CLLocationCoordinate2D, completion: @escaping () -> ()) {
        ...
        let circleURL = URL(string: "http://172.20.10.11/circle/")
    ...
    func start_game_cancel(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/start_game_cancel/")
    ...
    func checkSession(completion: @escaping (Bool) -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/check_session/")
    ...
    func logout(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/logout/")
    ...
    func app_terminate(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/app_terminate/")
    ...
    func delete_from_main_pool(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/delete_from_main_pool/")
    ...
    func during_game_cancel(statsInfo: StatsInfo, completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/during_game_cancel/")
    ...
    func add_to_history(giftsTaken: [String], statsInfo: StatsInfo, completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/add_to_history/")
    ...
    func add_to_friend(favoriteFriendsID: [String], completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11/add_to_friend/")
