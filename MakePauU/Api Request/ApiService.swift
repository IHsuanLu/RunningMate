...
class ApiService: NSObject{
    ...
    func postLogin(loginInfo: LoginInfo, completion: @escaping (String) -> ()){
        ...
        let checkSessionURL = URL(string: "http://172.20.10.11:80/login_member/")
    ...
    func postUserPosition(userLocation: CLLocationCoordinate2D, completion: @escaping () -> ()) {
        ...
        let circleURL = URL(string: "http://172.20.10.11:80/circle/")
    ...
    func start_game_cancel(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11:80/start_game_cancel/")
    ...
    func checkSession(completion: @escaping (Bool) -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11:80/check_session/")
    ...
    func logout(completion: @escaping () -> ()){
        ...
        let circleURL = URL(string: "http://172.20.10.11:80/logout/")
